  ...
  return (
    <main>
      ...
      <article className="max-w-3xl mx-auto p-5">
        <h1 className="font-extrabold text-3xl mt-10 mb-3 ">{post.title}</h1>
      ...
      {submitted ? (
        <div className="flex flex-col py-10 my-10 bg-yellow-500 text-white max-w-2xl mx-auto">
          ...
          <p>Once approved,it will approve belo!</p>
        </div>
      ) : (
        <form
